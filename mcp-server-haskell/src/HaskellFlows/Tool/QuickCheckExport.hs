-- | @ghci_quickcheck_export@ — materialize a runnable Haskell test
-- file from the persisted QuickCheck property store.
--
-- `ghci_quickcheck` auto-saves passing properties to
...
-- replays every persisted property the same way `ghci_regression`
...
renderTestFile props =
  ...
  in T.unlines $
       [ "-- Generated by ghci_quickcheck_export. Do not edit by hand;"
  ...
  let payload = object
        ...
        , "hint"
            .= ( "Commit the generated file and add QuickCheck to the \
                 \test-suite via ghci_deps. `cabal test` will replay \
